...
import EnterResponseButtons from './EnterResponseButtons';
...
class checkAssignedTicket extends Component {
    ...
    async actualMountAsync() {
        const { processInstanceId, id, name,level } = toJS(this.props.history.location.state.inboxDetail);
    ...
    handleSubmit = async (e) => {
        ...
        ticketStore.sendMessage(comments.comment, this.state.ticketId);
    };

    render() {
        let messageData = toJS(ticketStore.messages);
        //let comments = toJS(ticketStore.messages);
        const radioStyle = {
            display: 'block',
            height: '30px',
            lineHeight: '30px',
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            ...
                            <div className="buttons">
                                <div className="consignment-view-form">
                                    <form>
                                        <div className="pageTitles">
                                            <EnterResponseButtons data={this.state} />
                                        </div>
                                    </form>
                                </div>
                            </div>
